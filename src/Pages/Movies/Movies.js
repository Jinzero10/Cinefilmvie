    ...
    return (
        <main className="movies">
            ...
            <section>
                ...
                <Carousel rowId="2" fetchURL={requests.requestUpcoming} />
            </section>
            <section>
                <Title mainTitle="Animation" />
                <Carousel rowId="3" fetchURL={requests.requestAnimation} />
            </section>
            <section>
                <Title mainTitle="Adventure" />
                <Carousel rowId="4" fetchURL={requests.requestAdventure} />
            </section>
            <section>
            ...
            <section>
                ...
                <Carousel rowId="7" fetchURL={requests.requestMystery} />
            </section>
            <section>
                <Title mainTitle="Fantasy" />
                <Carousel rowId="8" fetchURL={requests.requestFantasy} />
            </section>
        </main>
    );
};
